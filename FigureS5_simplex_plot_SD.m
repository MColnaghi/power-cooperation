...
for j = 1:4
    ...
    ax1 = subplot(2,2,j);
    title(['\rm\itw\rm = ', num2str(w), ', \rm\itU\rm = ', num2str(u), newline])
    hold on
    ...
    scatter3(F(:,1), F(:,2), F(:,3), 24, stationary_dist,'filled','MarkerEdgeColor','none')
    xlabel('CCC')
    ylabel('CCD')
    colorbar(ax1)
    %ax1.Position(3) = 0.2;
...
% Create textbox
annotation('textbox',...
    [0.53 0.54 0.08 0.043],'String','(C,C,D)',...
    'FontSize',12,...
    'FitBoxToText','off',...
    'EdgeColor','none');
...
% Create textbox
annotation('textbox',...
    [0.08 0.067 0.08 0.043],'String','(C,C,D)',...
    'FontSize',12,...
    'FitBoxToText','off',...
    'EdgeColor','none');
...
% Create textbox
annotation('textbox',...
    [0.08 0.54 0.08 0.043],'String','(C,C,D)',...
    'FontSize',12,...
    'FitBoxToText','off',...
    'EdgeColor','none');
...
% Create textbox
annotation('textbox',...
    [0.53 0.067 0.08 0.043],'String','(C,C,D)',...
    'FontSize',12,...
    'FitBoxToText','off',...
    'EdgeColor','none');
